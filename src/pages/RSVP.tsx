          ...
          <div className="container-unified relative z-10">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8 max-w-3xl mx-auto">
                ...
                <div className="p-6 rounded-xl bg-card border-2 border-primary/20 shadow-lg">
                  ...
                  <div className="space-y-2">
                    <a href="https://www.google.com/maps/search/?api=1&query=13700+Boggy+Creek+Rd+Orlando+FL+32824" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:underline" aria-label="View location on Google Maps">
              ...
              <div className="text-center">
                <Button variant="hero" size="lg" onClick={() => smoothScrollTo('rsvp-form')} className="shadow-lg hover:shadow-xl transition-all duration-300 mb-3" aria-label="Scroll to registration form">
          ...
          <div className="container-unified">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="relative rounded-xl overflow-hidden shadow-xl bg-card border-2 border-primary/20">
                {!iframeLoaded && <div className="absolute inset-0 flex items-center justify-center bg-muted/50 z-10">
                    <div className="text-center">
                ...
                <iframe src={rsvpUrl} className="w-full min-h-[32rem] md:min-h-[50rem] border-0" title="Event RSVP Form" onLoad={() => setIframeLoaded(true)} allowFullScreen />
              </div>

              {/* Fallback */}
              <div className="mt-6 text-center">
                <Button variant="outline" onClick={() => window.open(rsvpUrl, '_blank')} className="gap-2" aria-label="Open registration form in a new tab">
                  Open in New Tab
                ...
                <div className="p-6 rounded-xl bg-card border border-border shadow-md">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-accent/5 transition-colors group">
                      ...
                      <button onClick={() => copyToClipboard('(706) 627-5729', 'phone')} className="touch-target p-1.5 hover:bg-accent/10 rounded transition-colors flex items-center justify-center" aria-label="Copy phone number">
                    ...
                    <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-accent/5 transition-colors group">
                      ...
                      <button onClick={() => copyToClipboard('vince@thesmartfinancialplan.com', 'email')} className="touch-target p-1.5 hover:bg-accent/10 rounded transition-colors flex items-center justify-center flex-shrink-0" aria-label="Copy email address">
                        {copiedEmail ? <Check className="w-4 h-4 text-accent" /> : <Copy className="w-4 h-4 text-muted-foreground" />}
                      </button>
                    </div>

                    <a href="https://thesmartfinancialplan.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-lg hover:bg-accent/5 transition-colors group">
                ...
                <div className="p-6 rounded-xl bg-card border border-border shadow-md">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <a href="https://www.google.com/maps/search/?api=1&query=111+N+Orange+Ave+Suite+800+Orlando+FL+32801" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:underline">
                        <MapPin className="w-4 h-4" />
                        Get Directions
                        <ExternalLink className="w-3 h-3" />
                      </a>
