...
const PremiumBackground = () => {
  return (
    <div className="fixed inset-0 w-full h-full -z-20 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-[5%] -left-[10%] w-[50%] h-[90%] bg-gradient-to-br from-sky-200/15 to-blue-300/10 blur-3xl rounded-full transform -rotate-12 animate-float"></div>
      
      {/* Abstract amber gradient shape (right) - more subtle */}
      <div className="absolute top-[15%] -right-[10%] w-[50%] h-[70%] bg-gradient-to-br from-gold-light/15 to-gold/10 blur-3xl rounded-full transform rotate-12 animate-float duration-10000"></div>
