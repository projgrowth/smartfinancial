...
export const getProcessSteps = (): ProcessStep[] => [
  {
    ...
    icon: React.createElement(Lightbulb, { className: "w-6 h-6 text-accent/60", "aria-hidden": "true" }),
    details: [
      {
  ...
  },
  {
    ...
    icon: React.createElement(Layers, { className: "w-6 h-6 text-accent/60", "aria-hidden": "true" }),
    details: [
      {
  ...
  },
  {
    ...
    icon: React.createElement(CheckCheck, { className: "w-6 h-6 text-accent/60", "aria-hidden": "true" }),
    details: [
      {
