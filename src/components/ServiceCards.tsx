          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                ...
                <Collapsible open={isOpen} onOpenChange={() => toggleItem(service.id)} className="mt-auto">
                  ...
                  <CollapsibleContent className="overflow-hidden data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up">
                    <ul className="flex flex-col gap-unified-xs border-t border-border/30 pt-4 mt-4">
                    ...
                    <Button
                      ...
                      className="w-full mt-4 bg-accent/10 hover:bg-accent/20 text-accent"
                    >
