    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-10 w-10 sm:h-8 sm:w-8 bg-transparent p-0 opacity-50 hover:opacity-100 touch-target"
        ),
        ...
        head_cell:
          "text-muted-foreground rounded-md w-10 sm:w-9 font-normal text-[0.8rem]",
        ...
        day: cn(
          ...
          "h-10 w-10 sm:h-9 sm:w-9 p-0 font-normal aria-selected:opacity-100 touch-target"
        ),
      ...
      components={{
        IconLeft: ({ ..._props }) => <ChevronLeft className="h-5 w-5 sm:h-4 sm:w-4" />,
        IconRight: ({ ..._props }) => <ChevronRight className="h-5 w-5 sm:h-4 sm:w-4" />,
      }}
      {...props}
    />
  );
