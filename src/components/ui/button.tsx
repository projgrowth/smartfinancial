  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-target",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background hover:bg-accent hover:text-accent-foreground active:scale-[0.98] min-h-11",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 active:scale-[0.98] min-h-11",
        ghost: "hover:bg-accent hover:text-accent-foreground active:scale-[0.98] min-h-11",
        ...
        subtle: "border border-input bg-transparent text-foreground hover:bg-accent/10 active:scale-[0.98] min-h-11",
      ...
      size: {
        ...
        sm: "h-auto min-h-10 rounded-md px-3",
        xs: "h-auto min-h-8 rounded-md px-2",
        lg: "h-auto min-h-12 rounded-md px-8",
        icon: "h-11 w-11",
