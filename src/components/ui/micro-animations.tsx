...
export const ShimmerButton = ({
  ...
  return (
    <button
      ...
      type={type}
      className={cn(
        "relative inline-flex items-center whitespace-nowrap leading-none gap-2 min-h-[44px] px-4 py-2 rounded-md font-medium text-primary-foreground overflow-hidden bg-primary hover:bg-primary/90 transition-colors",
